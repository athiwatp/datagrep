...
describe('datagrep.regression.linear.normalEqnSync', () => {
  ...
  it('computes theta for sample #0', () => {
    ...
    const [theta0, theta1] = datagrep.regression.linear.normalEqnSync(X, y)
  ...
  it('computes theta for sample #1', () => {
    ...
    const { X, y } = linearAlgebra.splitXySync(data)
    const [theta0, theta1, theta2] = datagrep.regression.linear.normalEqnSync(X, y)
